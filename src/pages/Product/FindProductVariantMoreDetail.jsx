...
const FindProductVariantMoreDetail = () => {
    ...
    useEffect(() => {
        API.get(apiConfig.findProductVariant.replace(":productVariantId", productVariantId))
            .then((res) => {
                setProductData(res);
    ...
    const rowsDiamond = useMemo(() => {
        return productVariantDiamond && productVariantDiamond.map((item) => {
            return {
                item: item,
                columns: [
    ...
    const rowsGemstone = useMemo(() => {
        return productVariantGemstone && productVariantGemstone.map((item) => {
            return {
                item: item,
                columns: [
    ...
    const rowsAttributes = useMemo(() => {
        return productVariantAttributes && productVariantAttributes.map((item, i) => {
    ...
    const rowsVariant = useMemo(() => {
        return productVariant && productVariant.map((item, i) => {
            ...
            return {
                ...
                columns: [
                    ...
                    <span>{productDetail.logoUrl === null ? "-" : productDetail.logoUrl}</span>,
    ...
    return (
        <>
            <Box
                ...
                sx={{ display: "flex", justifyContent: "space-between", padding: "20px 0px 10px 10px" }}
            >
                <Breadcrumb
                    routeSegments={[
            ...
            <Box style={{ padding: "20px 10px" }}>
                {productVariantDiamond !== undefined && (productVariantDiamond.length !== 0 && (
                    <Button variant="contained" onClick={() => setDiamondModel(true)}>Product Variant Diamonds</Button>
                ))}
            </Box>
            ...
            <Box style={{ padding: "20px 10px" }}>
                {productVariantGemstone !== undefined && productVariantGemstone.length > 0 && (
                    <Button variant="contained" onClick={() => setGemstoneModel(true)}>Product Variant Gemstone</Button>
                )}
            </Box>
            ...
            <Box style={{ padding: "20px 10px" }}>
                {productVariantAttributes !== undefined && productVariantAttributes.length > 0 && (
                    <Button variant="contained" onClick={() => setAttributeModel(true)}>Product Variant Attributes</Button>
                )}
            </Box>
            <ThemeDialog
            ...
            <Box style={{ padding: "20px 10px" }}>
                {productVariant !== undefined && productVariant.length > 0 && (
                    <Button variant="contained" onClick={() => setVariantMOdel(true)}>Product Variant Details</Button>
                )}
            </Box>
            <ThemeDialog
                isOpen={variantModel}

...
const FeatureProductMaster = () => {
    ...
    const paginate = (clear = false, isNewFilter = false) => {
        ...
        setLoading(true);
        API.get(apiConfig.allFeaturesProduct)
            .then((res) => {
                setLoading(false);
                setState({
                    data: res,
    ...
    const handleSaveButtonClick = () => {
        if (rowMoved) {
            ...
            API.put(apiConfig.updateFeatureProduct, payload)
                .then((res) => {
                    toaster.success('Feature Products updated successfully');
                    paginate();
                    setRowMoved(false);
                })
                .catch((error) => {
    ...
    const onClickDelete = (id) => {
        Swal.fire({
            title: "Are You Sure",
            text: "Are you sure you want to remove this Feature Product ?",
            icon: "question",
            ...
            if (result.isConfirmed) {
                API.destroy(`${apiConfig.allFeaturesProduct}/${id}`)
                    .then((res) => {
...
export default FeatureProductMaster;

...
const GemstoneMaster = () => {
  ...
  const COLUMNS = [
    ...
    { title: "Type", classNameWidth: "thead-second-width-title-price-78 thead-second-width-title-price-78_res" },
    ...
    {
      title: "Clarity",
      classNameWidth: "thead-second-width-action-carat carat_res",
    },
    {
      title: "Origin",
